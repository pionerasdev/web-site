...
class rootstrap_framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'rootstrap_media_scripts' ) );
	}
	...
	static function rootstrap_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function rootstrap_media_scripts( $hook ) {

		$menu = rootstrap_framework_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', rootstrap_framework_DIRECTORY .'js/media-uploader.js', array( 'jquery' ), rootstrap_framework::VERSION );
		wp_enqueue_script( 'of-media-uploader' );
		wp_localize_script( 'of-media-uploader', 'rootstrap_l10n', array(
